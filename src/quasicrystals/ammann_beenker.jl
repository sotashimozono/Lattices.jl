...
"""
function generate_ammann_beenker_projection(radius::Real; method::ProjectionMethod=ProjectionMethod())
...
- `QuasicrystalData{2,Float64}`: generated Ammann-Beenker tiling data
"""
function generate_ammann_beenker_substitution(generations::Int; method::SubstitutionMethod=SubstitutionMethod())
...
export AmmannBeenker, generate_ammann_beenker_projection, generate_ammann_beenker_substitution
