...
"""
function generate_penrose_projection(radius::Real; method::ProjectionMethod=ProjectionMethod())
    ...
    for n1 in -n_max:n_max, n2 in -n_max:n_max, n3 in -n_max:n_max,
        n4 in -n_max:n_max, n5 in -n_max:n_max
...
- `QuasicrystalData{2,Float64}`: generated Penrose tiling data
"""
function generate_penrose_substitution(generations::Int; method::SubstitutionMethod=SubstitutionMethod())
